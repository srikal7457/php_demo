...
<div class="HeroContent">
  <h1 class="HeroH1">Hostel application</h1>
  ...
  <div class="SocialMedia">
    <div class="SocialMediaWrap">
      ...
      <div class="SocialIcons">
        ...
        <a href="https://vitap.ac.in/twitter/" class="SocialIconLink"><i class="fa fa-twitter" aria-hidden="true"></i></a>
        <a href="https://www.instagram.com/vitap.university/" class="SocialIconLink"><i class="fa fa-instagram" aria-hidden="true"></i></a>
        <a href="https://www.youtube.com/@VITAP" class="SocialIconLink"><i class="fa-brands fa-youtube"></i></a>
      </div>
    </div>
